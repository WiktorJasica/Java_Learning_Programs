 ...
 * determine whether there is a root to leaf path in t such that the 
 * sum of vertex values equals s.
...
Return true if there is a path from root to leaf in t such that the
 sum of node values in it is equal to s, otherwise return false.
 */
public class HasPathWithGivenSum {
	...
	public static boolean hasPathWithGivenSum(Tree<Integer> root, int s) {
